...
class NotifikasiController extends Controller
{
    public function index()
    {
        ...
        return view('koor-ta.notifikasi', [
            'aktivitas' => $aktivitas,
            'title' => 'Notifikasi',
        ]);
    }
    ...
    public function data()
    {
        try {
            ...
            Log::error('KoorTA Notifikasi data error', ['error' => $e->getMessage()]);
    ...
    public function markAsRead($id)
    {
        try {
            ...
            Log::error('KoorTA Mark as read error', ['error' => $e->getMessage()]);
    ...
    public function readAll()
    {
        try {
            ...
            Log::error('KoorTA ReadAll error', ['error' => $e->getMessage()]);
            return response()->json(['success' => false, 'message' => $e->getMessage()], 500);
        }
    }
}
