<x-layout-dosen>
    ...
    <div x-data="pengaturanDosenPage()" class="space-y-6">
        ...
        <div class="bg-gradient-to-br from-emerald-500 to-green-600 text-white rounded-2xl shadow-xl p-6">
            <div class="flex items-center justify-between">
                <div class="flex-1">
                    ...
                    <p class="text-emerald-100 text-sm">Kelola informasi profil dan keamanan akun Anda</p>
                </div>
        ...
        <div class="bg-white rounded-2xl shadow-lg border-gray-100 overflow-hidden">
            ...
            <div class="bg-gradient-to-r from-emerald-50 to-green-50 px-6 py-4 border-b border-gray-200">
                <h3 class="text-lg font-bold text-gray-800 flex items-center gap-2">
                    <svg class="w-5 h-5 text-emerald-600" fill="none" stroke="currentColor" viewBox="0 0 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            d="M16 7a4 4 0 11-8 0 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7z" />
                    </svg>
                    Informasi Profil
                </h3>
            </div>
            ...
            {{-- Form --}}
            <form method="POST" action="{{ route('dosen.pengaturan.profile') }}" enctype="multipart/form-data"
                class="p-6">
                @csrf
                @method('PUT')
                ...
                <div class="space-y-6">
                    ...
                    <div class="flex items-start gap-6 pb-6 border-b border-gray-200">
                        ...
                        <div class="relative">
                            ...
                            @else
                                <div
                                    class="w-24 h-24 rounded-full bg-gradient-to-br from-emerald-500 to-green-500 flex items-center justify-center text-white text-3xl font-bold border-4 border-emerald-100">
                        ...
                        <div class="flex-1">
                            ...
                            <div class="flex items-center gap-4">
                                <label class="cursor-pointer">
                                    ...
                                    <span
                                        class="inline-flex items-center gap-2 px-4 py-2 bg-emerald-600 hover:bg-emerald-700 text-white rounded-lg font-medium transition-all shadow-sm hover:shadow-md">
        ...
        <div class="bg-white rounded-2xl shadow-lg border-gray-100 overflow-hidden">
            ...
            <div class="bg-gradient-to-r from-red-50 to-pink-50 px-6 py-4 border-b border-gray-200">
                <h3 class="text-lg font-bold text-gray-800 flex items-center gap-2">
                    <svg class="w-5 h-5 text-red-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2H6a2 2 0 00-2 2v6a2 2 002 2zm10-10V7a4 4 0 00-8 0v4h8z" />
                    </svg>
                    Keamanan & Password
                </h3>
            </div>
            ...
            {{-- Form --}}
            <form method="POST" action="{{ route('dosen.pengaturan.password') }}" class="p-6">
                @csrf
                @method('PUT')
                        ...
                        <div class="relative">
                            ...
                            <button type="button" @click="showCurrentPassword = !showCurrentPassword"
                                ...
                                <svg x-show="showCurrentPassword" class="w-5 h-5" fill="none"
                                    ...
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                        d="M13.875 18.825A10.05 10.05 0112 19c-4.478 0-8.268-2.943-9.543-7a9.97 9.97 0 011.563-3.029m5.858.908a3 3 0 114.243 4.243M9.878 9.878l4.242 4.242M9.88 9.88l-3.29m7.532 7.532l3.29 3.29M3 3l3.59 3.59m0 0A9.953 9.953 0 0112 5c4.478 0 8.268 2.943 9.543 7a10.025 10.025 0 01-4.132 5.411m0 0L21 21" />
                                </svg>
                            </button>
                        </div>
                    </div>
                        ...
                        <div class="relative">
                            ...
                            <button type="button" @click="showConfirmPassword = !showConfirmPassword"
                                ...
                                <svg x-show="showConfirmPassword" class="w-5 h-5" fill="none"
                                    stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                        d="M13.875 18.825A10.05 10.05 0 0112 19c-4.478 0-8.268-2.943-9.543-7a9.97 9.97 011.563-3.029m5.858.908a3 3 0 114.243 4.243M9.878 9.878l4.242 4.242M9.88 9.88l-3.29-3.29m7.532 7.532l3.29 3.29M3 3l3.59 3.59m0 0A9.953 9.953 0 0112 5c4.478 0 8.268 2.943 9.543 7a10.025 10.025 0 01-4.132 5.411m0 0L21 21" />
                                </svg>
                            </button>
                        </div>
                    </div>
        ...
        function pengaturanDosenPage() {
            return {
                ...
                async removeAvatar() {
                    ...
                    try {
                        const response = await fetch("{{ route('dosen.pengaturan.avatar.remove') }", {
                            method: 'DELETE',
                            headers: {
