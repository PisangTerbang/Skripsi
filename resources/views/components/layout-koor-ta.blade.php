...
<head>
    ...
    <title>{{ $title ?? 'Dashboard' }} - Koordinator TA</title>
        ...
        <aside :class="mobileMenu ? 'translate-x-0' : '-translate-x-full md:translate-x-0'"
            ...
            <div class="p-6 pb-4">
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        <h1 class="text-lg font-bold tracking-tight">Koordinator TA</h1>
                        <p class="text-[11px] text-indigo-300">Informatika UII</p>
                    </div>
                </div>
            </div>
