...
<body class="animated-gradient min-h-screen flex items-center justify-center p-4">
    ...
    <div class="w-full max-w-md">
        ...
        <div class="glass-card rounded-3xl p-8">
            <!-- Session Status -->
            @if (session('status'))
                <div class="mb-5 rounded-xl bg-emerald-50 border-emerald-200 px-4 py-3 text-sm text-emerald-700">
                    {{ session('status') }}
                </div>
            @endif
            ...
            <!-- Error -->
            @if ($errors->any())
                <div class="mb-5 rounded-xl bg-red-50 border-red-200 px-4 py-3 text-sm text-red-700 flex items-start gap-2">
                    ...
                    <div class="relative">
                        <div class="absolute inset-y-0 left-0 pl-3.5 flex items-center pointer-events-none">
                            <svg class="w-5 h-5 text-slate-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7z"/>
                            </svg>
                        </div>
                        <input
                            id="login"
