<x-layout-koor-ta title="Pengaturan Akun">
        ...
        <div class="grid grid-cols-1 gap-6 lg:grid-cols-3">
            ...
            <div class="space-y-4">
                ...
                <div class="overflow-hidden rounded-2xl border-2 border-gray-200 bg-white shadow-md">
                    <div
                        class="flex items-center gap-3 border-b-4 border-indigo-200 bg-gradient-to-r from-indigo-600 to-blue-700 px-5 py-4">
                        <div
                    ...
                    <div class="p-4 space-y-3">
                        ...
                        <div class="rounded-xl border-2 border-indigo-100 bg-indigo-50 px-4 py-3">
                            ...
                            <p class="text-sm font-black text-indigo-800">Koordinator Tugas Akhir</p>
                        </div>
                    </div>
                </div>
            ...
            <div class="space-y-6 lg:col-span-2">
                ...
                <div class="overflow-hidden rounded-2xl border-2 border-gray-200 bg-white shadow-md">
                    ...
                    <form method="POST" action="{{ route('koor-ta.pengaturan.profile') }}"
                        ...
                        <div class="flex items-center gap-5 rounded-xl border-2 border-gray-100 bg-gray-50 p-4">
                            <div class="relative shrink-0">
                                ...
                                @else
                                    <div
                                        class="flex h-16 w-16 items-center justify-center rounded-full bg-gradient-to-br from-indigo-500 to-blue-600 text-xl font-black text-white shadow-sm border-4 border-indigo-100">
                                        {{ strtoupper(substr($user->name, 0, 2)) }}
                                    </div>
                                @endif
                            </div>
                ...
                <div class="overflow-hidden rounded-2xl border-2 border-gray-200 bg-white shadow-md">
                    ...
                    <form method="POST" action="{{ route('koor-ta.pengaturan.password') }}" class="p-6 space-y-5">
                        @csrf
                        @method('PUT')
            ...
            function pengaturanPage() {
                return {
                    ...
                    async removeAvatar() {
                        ...
                        try {
                            const res = await fetch("{{ route('koor-ta.pengaturan.avatar.remove') }}", {
                                method: 'DELETE',
                                headers: {
