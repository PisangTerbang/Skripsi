<x-layout-prodi>
    <x-slot:title>Edit Periode</x-slot>
    ...
    <div class="mb-6">
        ...
        <p class="text-sm text-gray-600 mt-1">Perbarui informasi periode tugas akhir</p>
    </div>

    {{-- Form Card --}}
    <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
        <form action="{{ route('prodi.periode.update', $periode) }}" method="POST">
            @csrf
            @method('PUT')
            ...
            <div class="mb-5">
                ...
                <input type="text" name="tahun_akademik" id="tahun_akademik"
                    value="{{ old('tahun_akademik', $periode->tahun_akademik) }}" placeholder="Contoh: 2025/2026"
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-5 mb-5">
                <div>
                    ...
                    <input type="date" name="tanggal_buka" id="tanggal_buka"
                        value="{{ old('tanggal_buka', $periode->tanggal_buka ? $periode->tanggal_buka->format('Y-m-d') : '') }}"
                ...
                <div>
                    ...
                    <input type="date" name="tanggal_tutup" id="tanggal_tutup"
                        value="{{ old('tanggal_tutup', $periode->tanggal_tutup ? $periode->tanggal_tutup->format('Y-m-d') : '') }}"
            ...
            <div class="mb-5">
                ...
                <textarea name="keterangan" id="keterangan" rows="3"
                    ...
                    class="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-violet-500 focus:border-transparent transition @error('keterangan') border-red-500 @enderror">{{ old('keterangan', $periode->keterangan) }}</textarea>
                @error('keterangan')
                    <p class="text-red-500 text-sm mt-1.5 flex items-center gap-1">
                        <x-heroicon-o-exclamation-circle class="w-4 h-4" />
                        {{ $message }}
